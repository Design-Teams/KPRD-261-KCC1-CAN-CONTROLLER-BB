...
void Uart2_Data_Handler(void)
{
    ...
    if(memcmp(((char*)Uart2_array+1),",LP,",4) == 0)
    {
        ...
        N_Load = 0;
        N_ADC = 0;
        CAN_Rxpara.CANID = (uint16_t)(atol(token_buf[0]));
        N_Load = (uint16_t)(atol(token_buf[1]));
        N_ADC = (uint16_t)(atol(token_buf[2]));
        CAN_Txpara.CAN_Buf[4] = (uint8_t)(atol(token_buf[3]));
        CAN_Txpara.CAN_Buf[5] = (uint8_t)(((atol(token_buf[4]))& 0xFF00)>>8);
        CAN_Txpara.CAN_Buf[6] = (uint8_t)(((atol(token_buf[4]))& 0x00FF)>>0);
        CAN_Txpara.CAN_Buf[7] = (uint8_t)(atol(token_buf[5]));
...
void Can_Data_Send(void)
{
    ...
    if(can_frame_no == 0)
    {
        ...
        EUSART1_String("Before crc =");
        EUSART1_Write((uint8_t)(crc/10000)+0x30);
        EUSART1_Write((uint8_t)((crc%10000)/1000)+0x30);
        EUSART1_Write((uint8_t)(((crc%10000)%1000)/100)+0x30);
        EUSART1_Write((uint8_t)((((crc%10000)%1000)%100)/10)+0x30);
        EUSART1_Write((uint8_t)((((crc%10000)%1000)%100)%10)+0x30);
        EUSART1_String("\n");
        crc = Check_Sum(crc);
        EUSART1_String("After crc =");
        EUSART1_Write((uint8_t)(crc/10000)+0x30);
        EUSART1_Write((uint8_t)((crc%10000)/1000)+0x30);
        EUSART1_Write((uint8_t)(((crc%10000)%1000)/100)+0x30);
        EUSART1_Write((uint8_t)((((crc%10000)%1000)%100)/10)+0x30);
