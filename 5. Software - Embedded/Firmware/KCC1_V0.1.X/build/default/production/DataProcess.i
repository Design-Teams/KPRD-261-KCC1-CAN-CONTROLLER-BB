...
uint8_t can_buf[9],RxBuf[20],DADC[3],can_frame_no;
...
# 431 "DataProcess.c"
    ...
    recv = Read_ECan(0,&CANRID,8,0,RxBuf);
    if(recv)
    {
        if(CANRID == CANTID)
        {
            if((RxBuf[0]=='O') && (RxBuf[1]=='D'))
            {
            ...
            else if((RxBuf[0]=='T') && (RxBuf[1]=='M'))
            {
                Eeprom_Write(2,1);
                CANTID = 409;
            }
            else if((RxBuf[0]=='T') && (RxBuf[1]=='A'))
            {
                Eeprom_Write(2,2);
                CANTID = 410;
            }
            else if((RxBuf[0]=='C') && (RxBuf[1]=='S'))
            {
                if(RxBuf[2] == 1)
                {
                   Eeprom_Write(1,1);
